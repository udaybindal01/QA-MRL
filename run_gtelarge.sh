#!/bin/bash
#SBATCH --job-name=bam-gtelarge
#SBATCH --output=bam-gtelarge.out
#SBATCH --error=bam-gtelarge.err
...
./bam_council_pipeline.sh --backbone gtelarge --datasets "educational scifact nfcorpus fiqa"
