#!/bin/bash
#SBATCH --job-name=bam-jinav3
#SBATCH --output=bam-jinav3.out
#SBATCH --error=bam-jinav3.err
...
./bam_council_pipeline.sh --backbone jinav3 --datasets "educational scifact nfcorpus fiqa"
