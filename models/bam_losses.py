...
class BloomMaskedContrastiveLoss(nn.Module):
    ...
    def forward(
        ...
        # Query is masked; documents use full embeddings (v8 condition).
        # Matches eval: masked_q · full_doc. Using full docs gives a clear gradient
        # signal — the router must keep informative dims so the masked query can
        # retrieve full-dim documents.
