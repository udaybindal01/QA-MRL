#!/bin/bash
#SBATCH --job-name=bam-nomic
#SBATCH --output=bam-nomic.out
#SBATCH --error=bam-nomic.err
...
./bam_council_pipeline.sh --backbone nomic --datasets "educational scifact nfcorpus fiqa"
